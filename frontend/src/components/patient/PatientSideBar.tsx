...
function PatientSideBar() {
  ...
  return (
    <div className="flex content-center justify-center h-screen w-fit md:w-40 ml-1">
      <div className="h-fit my-auto w-fit md:w-32">
        <div className="h-9 border-[1px] w-fit md:w-32 text-center p-1 m-4 rounded-lg bg-white text-[#007E85] font-bold text-lg">
          <NavLink to="/profile">
        ...
        <div
          className="h-9 border-[1px] w-fit md:w-32 text-center p-1 m-4 rounded-lg bg-white text-[#007E85] font-bold text-lg cursor-pointer"
